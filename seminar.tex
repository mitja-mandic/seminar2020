...
na trgu nižja kot izvršilna, prodajalec plača kupcu razliko med tema cenama, torej \textdollar$25$. Kupec opcije sedaj drži kratko pozicijo
...
Kupcu opcije kritja na vzdrževalni račun ni potrebno nalagati, saj po plačilu cene opcije ne more izgubiti ničesar več. Za prodajalca pa to
...
Drugič, stran, ki more instrument izročiti, tvega, da bo ob izvršitv opcije na trgu pomanjkanje, kar dvigne ceno temu instrumentu (ang. \textit{delivery squeeze}).
...
Trenutne cene obveznic je običajno težje dobiti kot trenutne cene terminskih pogodb, saj se z obveznicamiv velikem delu trguje na prostem trgu, kjer
...
da bi si ustvaril jasnejšo sliko o njeni ceni ter določil ceno opcije. Nasprotno pa se s terminskimi pogodbami trguje na organiziranem trgu in so zato vsi 
